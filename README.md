[![Build Status](https://dev.azure.com/Sysop-Lutsk/Learn-Devops/_apis/build/status/ipetruniv.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/Sysop-Lutsk/Learn-Devops/_build/latest?definitionId=1&branchName=master)
